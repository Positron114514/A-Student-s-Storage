...
public class NodeContent{
    ...
    public boolean biggerThan(NodeContent target){
        return weight > target.getWeight();
    }

    public boolean smallerThan(NodeContent target){ return weight < target.getWeight();}
    ...
    public static NodeContent merge(NodeContent n1, NodeContent n2){
        return new NodeContent(n1.getContent().merge(n2.getContent()), n1.getWeight() + n2.getWeight());
    }
